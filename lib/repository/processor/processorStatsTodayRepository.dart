...
//  }
  ...
  Future fetch() async {
    ...
    List<dynamic> futureTeamToday = await super.fetch() as List<dynamic>;
    ...
    if(rowsUser[0]['Values'].length as int > 0){
      chartTimeAvailable.add(extractDataFromValues(columnNamesUser, 'TimeAvailableForTaskHr', rowsUser[0]['Values'], personalAxisName, true));
      tasksPerHourAvailable.add(extractDataFromValues(columnNamesUser, 'TasksPerLoggedInHour', rowsUser[0]['Values'], personalAxisName, true));
      avgRespTime.add(extractDataFromValues(columnNamesUser, 'AvgResponseTime', rowsUser[0]['Values'], personalAxisName, true));
      completionTimes.add(extractDataFromValues(columnNamesUser, 'AvgCompletionTime', rowsUser[0]['Values'], personalAxisName, true));
      tasksEscalated.add(extractDataFromValues(columnNamesUser, 'EscalatedCount', rowsUser[0]['Values'], personalAxisName, true));
      percentTasksEscalated.add(extractDataFromValues(columnNamesUser, 'PctEscalated', rowsUser[0]['Values'], personalAxisName, true));
    }
    ...
    if(rowsTeam[0]['Values'].length as int > 0){
      chartTimeAvailable.add(extractDataFromValues(columnNamesTeam, 'AvgTimeAvailableHr', rowsTeam[0]['Values'], teamAxisName, false));
      tasksPerHourAvailable.add(extractDataFromValues(columnNamesTeam, 'AvgTasksPerHour', rowsTeam[0]['Values'], teamAxisName, false));
      avgRespTime.add(extractDataFromValues(columnNamesTeam, 'AvgResponseTime', rowsTeam[0]['Values'], teamAxisName, false));
      completionTimes.add(extractDataFromValues(columnNamesTeam, 'AvgCompletionTime', rowsTeam[0]['Values'], teamAxisName, false));
      tasksEscalated.add(extractDataFromValues(columnNamesTeam, 'AvgEscalatedCount', rowsTeam[0]['Values'], teamAxisName, false));
      percentTasksEscalated.add(extractDataFromValues(columnNamesTeam, 'AvgPctEscalated', rowsTeam[0]['Values'], teamAxisName, false));
    }
